...
export const Arrow_DownRight = (props: React.SVGProps<SVGSVGElement>) => {
   return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" fill="white" style={{transform: "rotate(90deg)"}} {...props} >
